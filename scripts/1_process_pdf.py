...
def process_new_pdfs():
    ...
    for pdf_file in pdf_files:
        ...
        # Check for existing text file in condensed subfolder
        condensed_dir = Path('guidance') / 'condensed'
        condensed_dir.mkdir(exist_ok=True)  # Ensure directory exists
        text_file_path = condensed_dir / f"{pdf_file.stem}.txt"
        ...
        if not text_file_path.exists():
            ...
            if text:
                ...
                if cleaned_text:
                    ...
                    # Save in guidance/condensed folder as .txt file
