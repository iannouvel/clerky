...
Equally, if the note documents that the action has been done, started, prescribed, arranged, referred or booked, treat the action itself as satisfied — even where secondary detail (exact dose, route, timing or frequency) is omitted. Do not re-raise a satisfied action as an outstanding gap on the basis of missing secondary detail; at most append the missing detail to the existing item. Treat "arranged", "referred" or "booked" as satisfying a practice point whose action is to arrange, refer or book that step.
