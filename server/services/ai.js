...
Before honouring a documented why-not, check it runs in the same direction as the practice point's recommendation. A clinician who reasons their way into an action the guideline recommends against has documented the violation, not the rule-out: the suggestion still applies. Match the direction of the reasoning to the direction of the recommendation before deciding the practice point doesn't apply.
