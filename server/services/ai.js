...
Before deciding "applies", read the documented plan to determine which management pathway the team is on — surgical or conservative, inpatient or outpatient, active or expectant, interventional or watchful. A practice point premised on a different pathway from the one the plan describes does not apply, regardless of whether its specific action has been ticked off. The question isn't only "is this action documented?" — it is "does this action belong on the path this patient is on?"
